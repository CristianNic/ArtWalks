...
// let fileInputName = 'public-art-edited-377.csv'; 
// let fileOutputName = 'myOutputFile.json';

// // csvToJson.fieldDelimiter(';').generateJsonFileFromCsv(fileInputName,fileOutputName);
// csvToJson.fieldDelimiter(';').getJsonFromCsv(fileInputName,fileOutputName);
...
// CSV rows converted to JSON objects which will be added to result in an array 
let result = []; 
